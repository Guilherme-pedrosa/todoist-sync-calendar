...
export function ChatLauncher() {
  ...
  const taskConvs = conversations.filter((c) => {
    ...
    // Esconde apenas tarefas explicitamente concluídas.
    ...
    <>
      ...
      <button
        ...
        className={cn(
          ...
          'bg-primary text-primary-foreground hidden lg:flex items-center justify-center',
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-20 right-4 z-40 w-[380px] h-[560px] bg-popover border rounded-xl shadow-2xl hidden lg:flex flex-col overflow-hidden"
          >
